...
public class Menu extends javax.swing.JPanel {
    ...
    public Menu() {
        initComponents();
        setOpaque(false);
        pnlMoving.setBackground(this.getBackground());
    }
    ...
    protected void paintChildren(Graphics g) {
        ...
        GradientPaint gradient = new GradientPaint(0, 0, Color.decode("#dd1818"), 0, getHeight(), Color.decode("#333333"));
